...
class SaliencyLoss:
    ...
    def get_loss(self, _model, _images, _targets, _masks, _is_real_target=None, pt_store=None):
        ...
        total_loss = sigmoid_loss + fidelity_loss*0.1 + 0.1*(destroyer_loss + self.area_loss_coef*area_loss + self.smoothness_loss_coef*smoothness_loss + self.preserver_loss_coef*preserver_loss)
