...
class SaliencyLoss:
    ...
    def get_loss(self, _images, _targets, _masks, _is_real_target=None, pt_store=None, _masks2=None, _masks3=None):
        ...
        total_loss = (0.1**6)*sigmoid_loss + (0.1**2)*fidelity_loss + (0.1**6)*compactness_loss + destroyer_loss + self.area_loss_coef*area_loss + self.smoothness_loss_coef*smoothness_loss + self.preserver_loss_coef*preserver_loss
